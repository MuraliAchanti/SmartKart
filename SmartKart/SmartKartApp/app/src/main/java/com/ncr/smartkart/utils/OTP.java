...
/**
 * Created by achintyamongia on 23/10/17.
 */

@SuppressLint("AppCompatCustomView")
public class OTP extends EditText {
    ...
    public OTP(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mSpace = 24;//hardcoded multi * mSpace; //convert to pixels for our density
        ...
        try {
            ...
            drawables[1].setColorFilter(getResources().getColor(R.color.colorPrimary), PorterDuff.Mode.SRC_IN);
